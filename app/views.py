...
class ProductView(View):
    def get(self,request):
        ...
        cabinets = Product.objects.filter(category='C')
        chairsnseating = Product.objects.filter(category='CS')
        tables = Product.objects.filter(category='T')
        return render(request, 'app/home.html', {'beds':beds, 'cabinets':cabinets, 'chairsnseating':chairsnseating, 'tables':tables})
